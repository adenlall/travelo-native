...
export default function OverViewCard({image, title, tags, price=0}:{image:string,title:string,tags:Array<string>,price:any}) {
    ...
    return (
        <View style={{ borderWidth: 4, borderRadius: theme.roundness*3.5, borderColor: theme.colors.onPrimary, backgroundColor: theme.colors.primaryContainer, ...styles.container }}>
            ...
            >
                <>
                    <View style={{ alignItems: 'flex-start', justifyContent: 'flex-start', alignContent: "flex-start", width: '100%' }}>
                    ...
                    <View style={{ flex: 1, justifyContent: 'flex-end', gap:10 }}>
                        <Text variant='titleLarge' numberOfLines={2} style={{ color: theme.colors.onPrimaryContainer, lineHeight:23, fontWeight:'700' }}>
                            {title}
                        </Text>
                        <View>
